 ...
 */
import com.shimi.petep.NiaBuildType
...
android {
    defaultConfig {
        applicationId = "com.shimi.petep"
        versionCode = 11
        versionName = "2.0.0" // X.Y.Z; X = Major, Y = minor, Z = Patch level
        
        // Custom test runner to set up Hilt dependency graph
        testInstrumentationRunner = "com.shimi.petep.core.testing.PetepTestRunner"
        vectorDrawables {
